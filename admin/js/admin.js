    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (testConnectionBtn) {
            testConnectionBtn.addEventListener('click', function(e) {
                ...
                this.disabled = true;
                statusEl.innerHTML = '<span class="testing">' + nanato_github_updates.testing_connection + '</span>';
                ...
                .then(response => {
                    if (response.success) {
                        ...
                        statusEl.innerHTML = '<span class="error">' + nanato_github_updates.connection_error + response.data + '</span>';
                    }
                })
                .catch(error => {
                    console.error('Fetch Error:', error);
                    statusEl.innerHTML = '<span class="error">' + nanato_github_updates.connection_error + 'Server error occurred. Check your server logs.' + '</span>';
                })
                .finally(() => {
                    this.disabled = false;
                });
        ...
        if (checkGithubBtn) {
            checkGithubBtn.addEventListener('click', function(e) {
                ...
                .catch(error => {
                    console.error('Fetch Error:', error);
                    statusEl.innerHTML = '<span class="error">' + nanato_github_updates.connection_error + 'Server error occurred. Check your server logs and browser console for details.' + '</span>';
                })
                .finally(() => {
                    this.disabled = false;
                });
            ...
            searchForm.addEventListener('submit', function(e) {
                ...
                .then(response => {
                    if (response.success) {
                        ...
                        document.getElementById('nanato-github-repo-details').style.display = 'block';
                    } else {
                ...
                .catch(error => {
                    console.error('Fetch Error:', error);
                    alert(nanato_github_updates.search_error + 'Server error occurred. Check your server logs.');
                })
                .finally(() => {
        ...
        if (installForm) {
            installForm.addEventListener('submit', function(e) {
                ...
                statusEl.innerHTML = '<span class="installing">' + nanato_github_updates.installing + '</span>';
                ...
                .then(response => response.json())                .then(response => {
                    if (response.success) {
                        ...
                        statusEl.innerHTML = '<span class="error">' + nanato_github_updates.install_error + response.data + '</span>';
                    }
                })
                .catch(error => {
                    console.error('Fetch Error:', error);
                    statusEl.innerHTML = '<span class="error">' + nanato_github_updates.install_error + 'Server error occurred. Check your server logs and browser console for details.' + '</span>';
                })
                .finally(() => {
                    submitButton.disabled = false;
                    submitButton.textContent = originalText;
